...
divElement.setAttribute('class', 'screen p-0 w-100');
...
button1.setAttribute('class', 'btn w-100 h-100 text-primary')
...
button2.setAttribute('class', 'btn w-100 h-100 text-primary')
...
button3.setAttribute('class', 'btn w-100 h-100 text-primary')
...
button4.setAttribute('class', 'btn w-100 h-100 text-primary')
...
button17.setAttribute('class', 'btn w-100 h-100 text-danger')
